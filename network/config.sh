...
echo  'NodeOUs:
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/0-0-0-0-7055.pem
    OrganizationalUnitIdentifier: orderer' > /tmp/hyperledger/org2/admin/msp/config.yaml
sudo chmod -R 777 /tmp/hyperledger/org2/ca/crypto/msp/
echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    #修改对应的证书名称
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/0-0-0-0-7055.pem
    OrganizationalUnitIdentifier: orderer' > /tmp/hyperledger/org2/ca/crypto/msp/config.yaml
...
echo 'NodeOUs:
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/0-0-0-0-7055.pem
    OrganizationalUnitIdentifier: orderer' > /tmp/hyperledger/org2/peer1/msp/config.yaml
...
echo 'NodeOUs:
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/0-0-0-0-7055.pem
    OrganizationalUnitIdentifier: orderer' > /tmp/hyperledger/org2/peer2/msp/config.yaml