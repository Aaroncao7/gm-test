...
fabric-ca-client register -d --id.name peer1-org2 --id.secret peer1PW --id.type peer -u https://0.0.0.0:7052 --tls.certfiles /tmp/hyperledger/fabric-ca-tls/crypto/ca-cert.pem --home=/tmp/hyperledger/fabric-ca-tls/admin

fabric-ca-client register -d --id.name peer2-org2 --id.secret peer2PW --id.type peer -u https://0.0.0.0:7052 --tls.certfiles /tmp/hyperledger/fabric-ca-tls/crypto/ca-cert.pem --home=/tmp/hyperledger/fabric-ca-tls/admin
...
fabric-ca-client register -d --id.name admin-org2 --id.secret org2AdminPW --id.type admin -u https://0.0.0.0:7052 --tls.certfiles /tmp/hyperledger/fabric-ca-tls/crypto/ca-cert.pem --home=/tmp/hyperledger/fabric-ca-tls/admin
...
sudo chmod -R 777 /tmp/hyperledger/org2/ca

docker-compose -f docker-compose/org2-ca.yaml up -d
sleep 1
...
sudo chmod -R 777 /tmp/hyperledger/org2/peer1/assets/ca 
...
docker-compose -f docker-compose/org2-peer2.yaml up -d
...
# org2
cd /tmp/hyperledger/configtx && mkdir org2 
...
# 启动组织2的cli
docker-compose -f docker-compose/org2-cli.yaml up -d
